    ...
    public class AutenticacionExtension : AuthenticationStateProvider
    {
        ...
        public async Task ActualizarEstadoAutenticacion(SesionDTO sesionUsuario)
        {
            ...
            if(sesionUsuario != null)
            {
                ...
                await _localStorage.SetItemAsync("sesion", sesionUsuario);

            }
            else
            {
                claimsPrincipal = _sinInformacion;
                await _localStorage.RemoveItemAsync("sesion");
            }
        ...
        {
            var sesionUsuario = await _localStorage.GetItemAsync<SesionDTO>("sesion");
